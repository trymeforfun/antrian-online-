    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-link :href="route('hometown')" :active="request()->routeIs('hometown')">
                    {{ __('Summary') }}
                </x-nav-link>
                <x-nav-link :href="route('detail_data')" :active="request()->routeIs('detail_data')">
                    {{ __('Detail') }}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4">
                ...
                <div class="ml-3">
                    <div class="font-medium text-base text-gray-800">Kurniawan</div>
                    <div class="font-medium text-sm text-gray-500">kurniawan@gmail.com</div>
                </div>
            </div>
